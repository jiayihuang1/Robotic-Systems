...
# This class stores a representation of the physical environment in which
# the robot will operate. Note that the robot state is not stored here.
# The robot state is in the environment
...
class AirportMap(CellGrid):
    ...
    def is_terminal(self, x, y):
        ...
        return self._is_terminale.get(cell_type)        
    ...
    def compute_transition_cost(self, last_coords, current_coords):
        ...
        if cell_type == MapCellType.CUSTOMS_AREA:
            a = 100

        elif cell_type == MapCellType.SECRET_DOOR:
            a = 5
